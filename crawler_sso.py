"""
crawler_sso.py — CPCB EPR SSO Portal Crawler
URL: https://epr.cpcb.gov.in/login
...
PORTAL_NAME = "EPR SSO"
HOME_URL    = "https://epr.cpcb.gov.in/login"

async def crawl_sso_portal(portal_config, mode="full"):
    init_db()
...
if __name__ == "__main__":
    ...
    asyncio.run(crawl_sso_portal(p_config))
